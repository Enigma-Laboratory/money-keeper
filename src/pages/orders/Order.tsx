...
// // Step 2: Create a component to handle the event
...
//   // Step 3: Dispatch the custom event with data
//   const sendDataOnCustomEvent = () => {
//     document.dispatchEvent(new CustomEvent('myCustomEvent', { detail: { message: 'Hello, world!' } }));
//   };

//   // Step 4: Add an event listener for the custom event
//   React.useEffect(() => {
...
//   return (
//     <div>
//       <button onClick={sendDataOnCustomEvent}>Send Custom Event</button>
//       <p>{message}</p>
//     </div>
//   );
// }
